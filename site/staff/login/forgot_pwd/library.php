...
define("SMTP_UNAME", "2013ucp1652@mnit.ac.in"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "parthzsoft2895"); //Password for SMTP authentication
