...
-->		<form action="check.php" method="post" autocomplete="off">
   ...
   <input type="button" id="forget" value="Forgot your password"  /> </a><br />
			<a href="../../admin/admin_login.php" style="text-decoration:none;" ><input type="button"  id="create" value="Create an account" /></a><br />
