...
<body>
	...
	<div id="dlgbox">
		...
		<div id="dlg-footer">
			<a href="paybywallet.php" style="text-decoration:none;cursor:pointer;"><input type="button" value="Yes" ></a>
			<a href="finalbill.php" style="text-decoration:none;cursor:pointer;"><input type="button" value="No" ></a>
		</div>
	</div>
...
<?php
	echo "<script>show('Your bill is ".$_SESSION['pay']." Do you want to pay by wallet?')</script>";
