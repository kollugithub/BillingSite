...
<link rel="stylesheet" type="text/css" href="vdo_style.css" />
...
#reg { 
	background:url(../bg2.jpg) no-repeat right bottom;
...
<source src="../vdo7.mp4" type="video/mp4">
can't play
</video>
...
<div id="reg">
	...
	<div id="not" style="position:relative;left:6%;color:red;font-weight:bold;margin-bottom:8px;"></div>
		<form action="<?php echo $_SERVER['PHP_SELF'];?>" autocomplete="off" method="post" autocomplete="off">
			<label>Name </label><input type="text" id="name" name="name" maxlength="20" size="30" autofocus/><hr />
				...
				<label>Contact-number </label><input type="text" class="hover" id="no"  hovertext="so that interesting people can disturb you &#x263A" maxlength="10" name="no" size="30"/>
				<div id="hoverdiv"></div>
			</div>
