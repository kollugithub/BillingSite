...
-->		<form action="pwdchecking.php" method="post" autocomplete="off">
				<label>Password</label><input type="password" id="pwd" name="pwd" maxlength="40" autofocus size="30"/><br /><br /><br />
			</div>	
		<div id="center">
