...
-->		<form action="deletepage.php" method="post" autocomplete="off">
				<label>Product ID</label><input type="text" id="pid" name="pid" maxlength="40" autofocus onKeyUp="this.value = this.value.replace(/[^\d]+/, '');" size="30"/><br /><br /><br />
			</div>	
		<div id="center">
			<input type="submit" id="submit"  value="Delete"/><br /><br />
		</form>
		</div>
</div
></body>
